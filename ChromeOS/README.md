...
## Purpose
This is a C-based educational simulation of major Operating Systems concepts associated with **ChromeOS**.
...
### GCC / MinGW
```bash
gcc -std=c11 -Wall -Wextra -O2 chromeos_os_simulator.c -o chromeos_simulator
```

On Windows:
```text
chromeos_simulator.exe
```
