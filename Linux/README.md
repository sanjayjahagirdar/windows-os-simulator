# Linux OS Concepts Simulator

## Purpose
This is a C-based educational simulation of major Operating Systems concepts associated with **Linux**.
...
### GCC / MinGW
```bash
gcc -std=c11 -Wall -Wextra -O2 linux_os_simulator.c -o linux_simulator
```
