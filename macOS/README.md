# macOS OS Concepts Simulator

## Purpose
This is a C-based educational simulation of major Operating Systems concepts associated with **macOS**.
...
### GCC / MinGW
```bash
gcc -std=c11 -Wall -Wextra -O2 macos_os_simulator.c -o macos_simulator
```
